...
and fair corrective action in response to any behaviour that
...
the GitHub repository, Discussions, Issues, and any other forums
the community uses for communication. It also applies when an
...
account, or acting as an appointed representative at an online
or offline event.
...
for enforcement at
[s0ma@protonmail.com](mailto:s0ma@protonmail.com). All complaints
