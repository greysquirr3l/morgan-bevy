...
export default function Inspector() {
  ...
  const objectName =
    selectedCount === 1 && primaryObject ? primaryObject.name : `${selectedCount} objects`
    ...
    <div className="flex flex-col h-full">
      ...
      {selectedCount > 1 && (
        <div className="p-3 border-b border-editor-border">
          <div className="text-xs text-editor-textMuted">{selectedCount} objects selected</div>
        </div>
      )}
      ...
      <div className="flex-1 overflow-auto custom-scrollbar p-3 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('position', 'x', parseFloat(e.target.value) || 0)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('position', 'y', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="0.1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('position', 'z', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="0.1"
                />
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('rotation', 'x', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('rotation', 'y', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('rotation', 'z', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="1"
                />
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('scale', 'x', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="0.1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('scale', 'y', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="0.1"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e =>
                    handleTransformChange('scale', 'z', parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-2 py-1 text-xs bg-editor-bg border border-editor-border rounded focus:outline-none focus:border-editor-accent"
                  step="0.1"
                />
        ...
        {/* Tile Properties */}
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-editor-accent border-b border-editor-border/30 pb-1">
            Tile Properties
          </h4>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                maxLength={1}
                value={
                  primaryObject?.metadata?.tileChar ||
                  getTileChar(primaryObject?.metadata?.tileType || '1')
                }
                onChange={e => {
            ...
            <div className="text-xs text-editor-textMuted mt-1">Character used in 2D grid view</div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1">
                {['structure', 'exterior', 'interior', 'decorative', 'functional', 'temporary'].map(
                  preset => (
                    <button
                      key={preset}
                      onClick={() => {
